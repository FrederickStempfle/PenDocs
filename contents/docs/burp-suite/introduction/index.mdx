...
<Tabs defaultValue="community">
  <TabsList>
    ...
    <TabsTrigger value="enterprise">Enterprise Edition</TabsTrigger>
  </TabsList>
...
<Accordion type="single" collapsible>
  <AccordionItem value="intercepting-proxy">
    <AccordionTrigger>Intercepting Proxy</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="intruder">
    <AccordionTrigger>Intruder</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="repeater">
    <AccordionTrigger>Repeater</AccordionTrigger>
    <AccordionContent>

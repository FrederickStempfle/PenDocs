...
<Accordion type="single" collapsible>
  <AccordionItem value="extender-purpose">
...
<Accordion type="single" collapsible>
  <AccordionItem value="extensions-tab">
    <AccordionTrigger>Extensions Tab</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="loading-extensions">
    <AccordionTrigger>Loading Extensions</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="bapp-store">
    <AccordionTrigger>BApp Store Overview</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="popular-extensions">
    <AccordionTrigger>Popular and Essential Extensions</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="settings-tab">
    <AccordionTrigger>Settings Tab</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="extension-apis">
    <AccordionTrigger>Extension APIs</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="extension-workflow">
    <AccordionTrigger>Extension Workflow Integration</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="extension-configuration">
    <AccordionTrigger>Configuring Individual Extensions</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="scan-enhancement">
    <AccordionTrigger>Scan Enhancement Extensions</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="workflow-automation">
    <AccordionTrigger>Workflow Automation Extensions</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="specialized-testing">
    <AccordionTrigger>Specialized Testing Extensions</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="dev-basics">
    <AccordionTrigger>Development Basics</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="extension-capabilities">
    <AccordionTrigger>Extension Capabilities</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="dev-practices">
    <AccordionTrigger>Extension Development Best Practices</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="publishing">
    <AccordionTrigger>Publishing Extensions</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="extension-management">
    <AccordionTrigger>Extension Management</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="workflow-integration">
    <AccordionTrigger>Workflow Integration</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="common-issues">
    <AccordionTrigger>Common Extension Issues</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="debugging">
    <AccordionTrigger>Extension Debugging</AccordionTrigger>
    <AccordionContent>

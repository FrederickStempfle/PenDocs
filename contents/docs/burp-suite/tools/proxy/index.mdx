...
<Accordion type="single" collapsible>
  <AccordionItem value="proxy-purpose">
  ...
  <AccordionItem value="proxy-editions">
...
<Tabs defaultValue="manual">
  ...
  <TabsContent value="manual">
    <Steps>
      ### Configure Browser Proxy Settings Manually
      
      1. **Find your browser's proxy settings**
      ...
      2. **Configure the proxy settings**
         - Proxy type: HTTP
         - Proxy host/address: 127.0.0.1 (localhost)
         - Port: 8080 (Burp's default)
         - No proxy for: Leave empty or add exceptions as needed
      
      3. **Apply settings and test**
         - Visit any website to verify traffic is flowing through Burp
  ...
  <TabsContent value="extension">
    <Steps>
      ### Configure Using Browser Extension
      
      1. **Install the appropriate extension**
         - Chrome/Edge: Install "FoxyProxy" or "SwitchyOmega" from Chrome Web Store
         - Firefox: Install "FoxyProxy" from Firefox Add-ons
...
<Accordion type="single" collapsible>
  <AccordionItem value="proxy-listeners">
    <AccordionTrigger>Configuring Proxy Listeners</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="invisible-proxying">
    <AccordionTrigger>Invisible Proxying</AccordionTrigger>
    <AccordionContent>
...
<Tabs defaultValue="basic">
  <TabsList>
    <TabsTrigger value="basic">Basic Interception</TabsTrigger>
...
<Accordion type="single" collapsible>
  <AccordionItem value="history-overview">
    <AccordionTrigger>Working with HTTP History</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="history-analysis">
...
<Accordion type="single" collapsible>
  <AccordionItem value="websockets-overview">
    <AccordionTrigger>Working with WebSockets</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="match-replace-basic">
    <AccordionTrigger>Basic Match and Replace</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="match-replace-advanced">
    <AccordionTrigger>Advanced Match and Replace (Professional)</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="intercept-rules">
    <AccordionTrigger>Intercept Rules</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="response-modification">
    <AccordionTrigger>Response Modification (Professional)</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="auth-testing">
    <AccordionTrigger>Testing Authentication Mechanisms</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="input-testing">
    <AccordionTrigger>Testing Input Validation</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="session-testing">
    <AccordionTrigger>Testing Session Management</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="tool-integration">
    <AccordionTrigger>Workflow with Other Burp Tools</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="mobile-testing">
    <AccordionTrigger>Mobile Application Testing</AccordionTrigger>
    <AccordionContent>

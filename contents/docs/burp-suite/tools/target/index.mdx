...
<Accordion type="single" collapsible>
  <AccordionItem value="target-purpose">
...
<Accordion type="single" collapsible>
  <AccordionItem value="site-map-overview">
    <AccordionTrigger>Site Map Overview</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="site-map-population">
    <AccordionTrigger>Populating the Site Map</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="navigation">
    <AccordionTrigger>Navigating the Site Map</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="analysis-features">
    <AccordionTrigger>Analysis Features</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="context-menu">
    <AccordionTrigger>Site Map Context Menu</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="scope-definition">
    <AccordionTrigger>Defining Target Scope</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="scope-effects">
    <AccordionTrigger>Effects of Scope Settings</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="advanced-scope">
    <AccordionTrigger>Advanced Scope Features (Professional Edition)</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="issue-tracking">
    <AccordionTrigger>Vulnerability Tracking</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="analyzer-features">
    <AccordionTrigger>Target Analysis Features</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="recon-techniques">
    <AccordionTrigger>Application Reconnaissance</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="mapping-workflow">
    <AccordionTrigger>Mapping Workflow</AccordionTrigger>
    <AccordionContent>
      A systematic approach to mapping applications:
      
      <Steps>
        <Step title="Define initial scope">
        ...
        <Step title="Automated discovery">
          Use Spider and content discovery (Professional Edition) to find additional resources.
        </Step>
...
<Accordion type="single" collapsible>
  <AccordionItem value="workflow-integration">
    <AccordionTrigger>Integrating with Testing Workflow</AccordionTrigger>
    <AccordionContent>
...
<Accordion type="single" collapsible>
  <AccordionItem value="organization-tips">
    <AccordionTrigger>Organization and Efficiency</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="scope-best-practices">
    <AccordionTrigger>Scope Management Best Practices</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="common-issues">
    ...
    <AccordionContent>
      ...
      2. **Missing content in Site Map**
         - Check for client-side routing (SPA applications)
...
<Accordion type="single" collapsible>
  <AccordionItem value="content-discovery">
    <AccordionTrigger>Content Discovery</AccordionTrigger>
    <AccordionContent>
  ...
  <AccordionItem value="target-analyzer">
    <AccordionTrigger>Target Analyzer</AccordionTrigger>
    <AccordionContent>

...
<Tabs defaultValue="overview" className="pt-5 pb-1">
  ...
  <TabsContent value="versions">
    - **John the Ripper 1.9.0-jumbo-1** from 2019: Latest jumbo version with enhanced features
    - **John the Ripper 1.8.0-jumbo-1** from 2014: Major jumbo release with expanded hash support
    - **John the Ripper 1.7.9** from 2011: Improved performance and added features
    - **John the Ripper 1.7.0** from 2008: Enhanced multi-platform support
  </TabsContent>
</Tabs>

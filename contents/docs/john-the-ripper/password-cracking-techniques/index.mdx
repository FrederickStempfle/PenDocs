...
Learn more in the [Dictionary Attacks](/docs/john-the-ripper/password-cracking-techniques/dictionary-attacks) section.
...
Learn more in the [Rule-Based Attacks](/docs/john-the-ripper/password-cracking-techniques/rule-based-attacks) section.
...
Learn more in the [Brute Force Attacks](/docs/john-the-ripper/password-cracking-techniques/brute-force-attacks) section.
...
1. **Start with the fastest methods** (dictionary) before moving to slower ones (brute force)

...
<Note title="Database Support">
File system access capabilities vary by DBMS:
- MySQL: Requires FILE privilege
- PostgreSQL: Limited to files in the database directory
- Microsoft SQL Server: Requires appropriate permissions
- Oracle: Requires specific privileges
</Note>
...
<Note title="Warning">
Writing files to a server without proper authorization is illegal in most jurisdictions. This functionality should only be used in authorized penetration testing scenarios.
</Note>
...
<Note title="Ethical Considerations">
